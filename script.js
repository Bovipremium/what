...
function downloadProgram() {
    // Aqui você pode adicionar o link real para download
    alert('Link de download será fornecido em breve!\n\nPara obter o link, entre em contato via WhatsApp.');
    openWhatsApp();
}

// Função para abrir WhatsApp
function openWhatsApp() {
    const phoneNumber = '5562991346599';
    const message = encodeURIComponent('Olá! Gostaria de obter informações sobre o OneDrive para MacBook.');
